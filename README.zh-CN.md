...
- **把多工具历史放进一个工作台**：Claude Code、Codex CLI、Antigravity、Kimi Code、Cursor CLI、OpenCode、CC-Mirror 和 Pi。
...
SessionView 当前读取 Claude Code、Codex CLI、Antigravity、Kimi Code、Cursor CLI、OpenCode、CC-Mirror 和 Pi 的本地历史。
